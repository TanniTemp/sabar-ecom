    ...
    <div className="w-full pt-[100px] no-scrollbar min-h-screen overflow-x-hidden relative p-10">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-screen-xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div className="grid grid-cols-6  gap-2 items-cente md:font-bold md:text-2xl">
            <button onClick={() => setSelectedQuantity(selectQuantity - 1)} disabled={selectQuantity <= 1} className="cursor-pointer  border-4 border-black bg-white   flex items-center justify-center">
            <Minus color="black" />
            </button>
            <div className="flex items-center col-span-4 justify-center">{selectQuantity}</div>
            <button onClick={() => setSelectedQuantity(selectQuantity + 1)} className="cursor-pointer bg-white border-white  border-2 flex items-center justify-center"> 
            <Plus color="black" />
            </button>
          </div>
        </div>
      ...
      <div className="max-w-screen-xl flex items-start justify-start flex-col gap-5 mt-10 mx-auto">
       ...
       <div>
          ...
          <ul className="list-disc pl-5 text-sm md:text-md text-gray-400">
